...
*/
    ...
    _onImageError: function () {
        this._imgNode.onload = this._imgNode.onerror = null;
        this.fire('error');
    },

    _onImageLoad: function () {
console.log('_onImageLoad', this._imgNode.onload);
        if (this.options.clip) {
    ...
    _reset: function () {
        ...
        if (this.options.clip && !this._clipDone) {
