...
L.Wind2d = L.Class.extend({
  ...
  var field = VectorField.read(windData, true);
        var display = new MotionDisplay(canvas, null, field, 5000, mapProjection);
var mapAnimator = new Animator();
...
L.wind2d = function (map, options) {
    return new L.Wind2d(map, options);
};
